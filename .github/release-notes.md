...
برای مطالعهٔ توضیحات کامل دربارهٔ نحوهٔ پاک‌سازی لاگ‌ها و حفظ حریم خصوصی، می‌توانید به [README فارسی پروژه](https://github.com/clunky-widget/Aether/blob/main/README.fa.md) مراجعه کنید.